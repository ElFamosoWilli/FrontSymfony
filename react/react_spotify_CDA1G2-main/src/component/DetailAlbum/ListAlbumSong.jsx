                        ...
                        <table className="min-w-full text-left text-sm font-light">
                            ...
                            <tbody>
                                ...
                                songs.map((row,index)=> {
                                    ...
                                    //on formate le temps en mm::ss 
                                    const duration = seconds < 10 ? `${minutes}:0${seconds}` : `${minutes}:${seconds}`;
                                    ...
                                    return (
                                        ...
                                        >
                                            <td className='whitespace-nowrap px-6 py-4 font-medium m-1 w-1/3 h-16 '>
                                                {/* on va utiliser la constante isHover pour afficher le bouton play */}
